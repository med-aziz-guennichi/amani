...
const Commercials = () => {
  ...
  const [nb_leads_affectees, setNb_leads_affectees] = useState("");
  ...
  const getAllComercials = async () => {
    const data = await axios.get(
      "http://localhost:8080/commercial/getAllCommercial"
    );
    console.log(data);
  ...
  const handleSubmit = async (e) => {
    ...
    newForm.append("matricule", matricule);
    newForm.append("nb_leads_affectees", nb_leads_affectees);

    await axios
      .post(
        "http://localhost:8080/commercial/create-commercial",
        newForm,
        config
      )
      .then((res) => {
