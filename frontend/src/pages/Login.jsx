...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    loginAdmin(dispatch, { email, motDePasse });
  };
      ...
      <div className="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div className="d-flex flex-column flex-lg-row flex-column-fluid">
          ...
          <div
            ...
            style={{
              backgroundImage: `url("process.env.PUBLIC_URL/dist/assets/media/misc/auth-bg.png"})`,
            }}
          >
            {/*begin::Content*/}
            <div className="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
              ...
              <img
                ...
                src={process.env.PUBLIC_URL + "/dist/assets/media/misc/01.png"}
                alt
              />
              {/*end::Image*/}
              {/*begin::Title*/}
