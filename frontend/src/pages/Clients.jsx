...
const Clients = () => {
  ...
  const getAllClients = async () => {
    const data = await axios.get("http://localhost:8080/client/getAllClients");
    console.log(data);
  ...
  const handleSubmit = async (e) => {
    ...
    newForm.append("nom", nom);
    newForm.append("prenom", prenom);
    newForm.append("email", email);
    newForm.append("adresse", adresse);
    newForm.append("cin", cin);
    newForm.append("numeroTel", numeroTel);
    newForm.append("dateNaissance", dateNaissance);
    newForm.append("motDePasse", motDePasse);
    newForm.append("NomRepresentant", NomRepresentant);
    newForm.append("DomaineDactivite", DomaineDactivite);
    newForm.append("nomEntreprise", nomEntreprise);
    newForm.append("codePostale", codePostale);

    axios
      .post("http://localhost:8080/client/create-client", newForm, config)
      .then((res) => {
        console.log(res);
      })
      .catch((error) => {
                                    ...
                                    >
                                      ...
                                      <div className="fv-row mb-7">
                                        ...
                                        <input
                                          ...
                                          onChange={(e) =>
                                            setNomRepresentant(e.target.value)
                                          }
                                        />
                                        {/*end::Input*/}
                                      </div>
                                      ...
                                      <div className="fv-row mb-7">
                                        ...
                                        <input
                                          type="text"
                                          className="form-control form-control-solid mb-3 mb-lg-0"
                                          placeholder="Domaine Dactivite"
                                          onChange={(e) =>
                                            setDomaineDactivite(e.target.value)
                                          }
                                        />
                                        {/*end::Input*/}
                                      </div>
