            ...
            <div id="kt_app_toolbar" className="app-toolbar py-3 py-lg-6">
              ...
              <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                ...
                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                  {/*begin::Title*/}
                  <h1 className="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Calendar</h1>
                  {/*end::Title*/}
                </div>
                {/*end::Page title*/}
                {/*begin::Actions*/}
                <div className="d-flex align-items-center gap-2 gap-lg-3">
                  ...
                  <div className="m-0">
                    ...
                    {/*end::Menu toggle*/}
                    {/*begin::Menu 1*/}
                    <div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63d0da7c45502">
                      {/*begin::Header*/}
                      ...
                      <div className="px-7 py-5">
                        ...
                        <div className="mb-10">
                          ...
                          {/*begin::Input*/}
                          <div>
                            <select className="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63d0da7c45502" data-allow-clear="true">
                              <option />
                        ...
                        <div className="modal-body py-10 px-lg-17">
                          ...
                          <div className="fv-row mb-9">
                            ...
                            <label className="form-check form-check-custom form-check-solid">
                              ...
                              <span className="form-check-label fw-semibold" htmlFor="kt_calendar_datepicker_allday">All Day</span>
                            </label>
                            {/*end::Checkbox*/}
                          </div>
                          {/*end::Input group*/}
...
<script src="assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
		...
		<script src={process.env.PUBLIC_URL+"/dist/assets/js/custom/apps/calendar/calendar.js"}></script>
