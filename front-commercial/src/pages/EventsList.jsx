            ...
            <div id="kt_app_toolbar" className="app-toolbar py-3 py-lg-6">
              ...
              <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                ...
                <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                  {/*begin::Title*/}
                  <h1 className="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Events List</h1>
                  {/*end::Title*/}
                  {/*begin::Breadcrumb*/}
                        ...
                        <tr>
                          ...
                          <td className="d-flex align-items-center">
                            ...
                            <div className="d-flex flex-column">
                              <a href="../../demo1/dist/apps/user-management/users/view.html" className="text-gray-800 text-hover-primary mb-1">{item.nom} {item.prenom}</a>
